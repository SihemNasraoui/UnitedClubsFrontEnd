...
class Universite extends Component {
  ...
  onChange(e){
    ...
    this.demoMethod1(this.state.Nom_Ecole);
      ...
      <div>
        ...
        <div id="tunisdiv" style={{ display: 'none' }} >
          <InputGroup className="mb-3">
            ...
            <Input type="select" onChange={this.onChange.bind(this)} name="Nom_Ecole"  >
        ...
        <div id="manardiv" style={{ display: 'none' }} >
          <InputGroup className="mb-3">
            ...
            <Input type="select" onChange={this.onChange} name="Nom_Ecole" >
              <option disabled selected>Select </option>
