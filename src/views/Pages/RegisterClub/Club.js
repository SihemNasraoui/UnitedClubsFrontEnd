...
class Club extends Component {
  ...
  constructor(props) {
    ...
    this.handleChangeIdClub = this.handleChangeIdClub.bind(this);
...
handleChangeIdClub = event => {   this.setState({ Id_Club: event.target.value }); }
...
onSubmit = event => {
  ...
  axios.post('https://localhost:5001/api/Club', club)
      .then((res) => {
console.log(res)
console.log(res.data.Nom_Ecole);
console.log(res.data.Nom_université);
console.log(res.data)
this.props.history.push('/loginClub');
      }).catch((error) => {

          console.log(error)
      });

  this.setState({ Nom_Club: '',  Id_Club: '', Téléphone_Club: '', Nombre_Membres: '', Description: '', Date_Création: '', Email: '', Password: '', Nom_université: '', Nom_Ecole: '', logo: ''})
}
    ...
    />
                  ...
                  <form onSubmit={this.onSubmit}> 
                    ...
                    <InputGroup className="mb-3">
                      ...
                      <Input type="textarea" name="this.state.Id_Club" required placeholder=" Identifiant club" autoComplete=" id of the club" onChange={this.handleChangeIdClub}/>
                    </InputGroup>
