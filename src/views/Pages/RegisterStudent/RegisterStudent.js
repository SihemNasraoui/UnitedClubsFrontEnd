...
class RegisterStudent extends Component {
  ...
  constructor(props) {
    ...
    this.handleChangeSexeU = this.handleChangeSexeU.bind(this);
    ...
    this.handleChangeNom_Ecole_Etudiant = this.handleChangeNom_Ecole_Etudiant.bind(this);
...
handleChangeSexeU = event => {   this.setState({ SexeU: event.target.value }); }
handleChangeMot_de_passe = event => {   this.setState({Mot_de_passe : event.target.value }); }
...
onSubmit = event => {
  ...
  axios.post('https://localhost:5001/api/Etudiant', user)
      .then((res) => {
                ...
                <CardBody className="p-4">
                  ...
                  <form onSubmit={this.onSubmit}>
                    ...
                    <InputGroup className="mb-3">
                      ...
                      <Input type="password"  value={this.state.Mot_de_passe} placeholder="Password" autoComplete="new-password" onChange={this.handleChangeMot_de_passe} />                       <Input type="password" placeholder="Repeat password" autoComplete="new-password" />
...
<div id="tunisdiv" style={{ display: 'none' }} >
  <InputGroup className="mb-3">
    ...
    <Input type="select" value={this.state.Nom_Ecole_Etudiant} onChange={this.handleChangenomecole} name="etablissement" >
